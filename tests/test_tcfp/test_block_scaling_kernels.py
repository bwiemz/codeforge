...
from codeforge.tcfp.core import (
    FP8_E4M3_MAX,
    TCFPMode,
)
...
_HAS_TRITON = False
try:
    from codeforge.tcfp.kernels import (
...
class TestFusedBackwardDX:
    ...
    def test_matches_reference(self, M: int, D_out: int, D_in: int, bs: int) -> None:
        ...
        from codeforge.tcfp.kernels import block_quantize_fp8  # type: ignore
...
class TestBlockScaledIntegration:
    ...
    def test_convert_to_tcfp_passes_param(self) -> None:
        from codeforge.tcfp.nn import TCFPLinear, convert_to_tcfp
...
class TestFusedWtQuantDualGemm:
    ...
    def test_matches_separate_quantize_plus_gemm(self, block_size: int) -> None:
        ...
        from codeforge.tcfp.kernels import fused_dual_quantize_fp8  # pyright: ignore[reportMissingImports]
