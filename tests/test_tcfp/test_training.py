...
from codeforge.tcfp.nn import TCFPLinear
from codeforge.tcfp.training.checkpointing import ShieldWorldArchiver, TCFPCheckpointer
from codeforge.tcfp.training.curriculum import (
    CUSUMPhaseDetector,
    PhaseConfig,
    ProgressiveQuantizer,
    QuantizationCurriculum,
)
from codeforge.tcfp.training.monitoring import GradientCorruptionDetector, TCFPMonitor
from codeforge.tcfp.training.policy import (
...
from codeforge.tcfp.training.presets import TrainingPreset
...
class TestEFMABF16Fallback:
    ...
    def test_efma_bf16_fallback(self) -> None:
        ...
        from codeforge.tcfp.training.policy import MomentumAlignmentState
